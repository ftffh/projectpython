...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,x='Vehicle_Type',y='Automobile_Sales',title='Average number vehiles sold by type during recession'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4=dcc.Graph(figure=px.bar(unemployment_sales,x='unemployment_rate',y='Automobile_Sales',color='Vehicle_Type',title='Effects on vehicle type and unemployment on sales'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.lines(mas,x='Month',y="Automobile_Sales",title='Monthly Auto Sales'))
